...
public class ClusterHealth extends HealthTemplate{
	...
	protected String checkReplicationSAPHana(String guid) {
		...
		SQL += "CASE WHEN result_number < 100 THEN '" + gData.tr("81f15e97-f500-407a-b94d-3341659581c9") + "' ELSE '" + gData.tr("9ee99228-89a5-4828-95b2-d453310e3987") + "' END AS 'work_status',  ";
	...
	public String checkHealthHPSG(String guid) {
		...
		SQL += "TIMESTAMPDIFF(MINUTE,a.check_date, NOW()) AS 'past_minutes', ";
		SQL += "CASE WHEN result_number < 10 THEN '" + gData.tr("81f15e97-f500-407a-b94d-3341659581c9") + "' ELSE '" + gData.tr("9ee99228-89a5-4828-95b2-d453310e3987") + "' END AS 'work_status', ";
